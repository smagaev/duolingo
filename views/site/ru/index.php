    ...
    <div class="site-index">
        ...
        <div class="body-content text-center">
            ...
            for ($i = 0; $i < count($words); $i++) {
                $k = $i + 1;
                $id_rand = count($words);
                $arr_eng[$i] = '<div id = ' . $n . ' class="btn btn-lg my_btn btn_act btn-default border-dark col-4" data-i="'. $words[$i]->id .'" data-id="' . $k . '"><span class="display">' . $words[$i]->word . '</span></div>';
                $n++;
                $arr_tr[$i] = '<div id = ' . $n . '  class="btn btn-lg my_btn btn_act btn-default border-dark col-4" data-i="'. $words[$i]->id .'" data-id="' . $k . '"><span>' . $words[$i]->var1 . '</span></div>';
                $n++;
            }
